    ...
    <section class="mt-4" data-aos="fade-down" id="inicio">
        <div class="mt-8 px-8 sm:px-24 md:px-60 lg:px-60 xl:px-60 2xl:px-60 grid grid-cols-1 xl:grid-cols-2 gap-6 py-4">
            <div class="w-full rounded-xl flex flex-col justify-center">
                <h1 class="text-lg py-1 font-semibold">Acessibilidade</h1>
                <p class="text-lg py-1 font-normal text-gray-600">As páginas do Portal da Aspar foram projetadas para serem acessíveis e facilmente utilizáveis. Se você tiver sugestões ou encontrar problemas, por favor, entre em contato e ajude-nos a melhorar a sua experiência.</p>
            </div>
            <div
